...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">{{ __('patientcare.editAppointment') }} - {{ $patient->name }} {{ $patient->lastNames }}</div>
				...
				<div class="card-body">
					...
					<form method="POST" action="/patient/{{ $patient->id }}/appointment/{{ $appointment->id }}">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<textarea id="symptoms" class="form-control{{ $errors->has('symptoms') ? ' is-invalid' : '' }}" name="symptoms" autofocus>{{ $appointment->symptoms }}</textarea>
						...
						<div class="row">
							...
							<div class="form-group col-md-2">
								...
								<input id="heartrate" type="text" class="form-control{{ $errors->has('heartrate') ? ' is-invalid' : '' }}" name="heartrate" value="{{ $appointment->heartrate }}" autofocus>
							...
							<div class="form-group col-md-2">
								...
								<input id="bloodpressure" type="text" class="form-control{{ $errors->has('bloodpressure') ? ' is-invalid' : '' }}" name="bloodpressure" value="{{ $appointment->bloodpressure }}" autofocus>
							...
							<div class="form-group col-md-2">
								...
								<input id="temp" type="text" class="form-control{{ $errors->has('temp') ? ' is-invalid' : '' }}" name="temp" value="{{ $appointment->temp }}" placeholder="°{{ __('patientcare.tempUnit') }}" autofocus>
								@if ($errors->has('temp'))
									<span class="invalid-feedback" role="alert">
						...
						<div class="row">
							...
							<div class="form-group col-md-2">
								...
								<input id="weight" type="text" class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}" name="weight" value="{{ $appointment->weight }}" placeholder="{{ __('patientcare.weightUnit') }}" autofocus>
							...
							<div class="form-group col-md-2">
								...
								<input id="height" type="text" class="form-control{{ $errors->has('height') ? ' is-invalid' : '' }}" name="height" value="{{ $appointment->height }}" placeholder="{{ __('patientcare.heightUnit') }}" autofocus>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<textarea id="exploration" class="form-control{{ $errors->has('exploration') ? ' is-invalid' : '' }}" name="exploration" >{{ $appointment->exploration }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<textarea id="prevStudies" class="form-control{{ $errors->has('prevStudies') ? ' is-invalid' : '' }}" name="prevStudies" >{{ $appointment->prevStudies }}</textarea>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="diagnosis" type="text" class="form-control{{ $errors->has('diagnosis') ? ' is-invalid' : '' }}" name="diagnosis" value="{{ $appointment->diagnosis }}" required autofocus>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<textarea id="treatment" class="form-control{{ $errors->has('treatment') ? ' is-invalid' : '' }}" name="treatment" >{{ $appointment->treatment }}</textarea>
